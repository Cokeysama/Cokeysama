...
![skills](https://skillicons.dev/icons?i=c,cpp,go,py,html,css,js,nodejs,java,md,pytorch,tensorflow,express,qt,react,cmake,docker,git,linux,nginx,mysql,githubactions,heroku,vercel,visualstudio,vscode)
